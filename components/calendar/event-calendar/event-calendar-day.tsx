...
import { generateTimeSlots } from "@/lib/calendar/date-utils";
...
import { useDayEventPositions } from "@/lib/calendar/event-utils";
        ...
        <div className="relative mt-2 mb-2">
          ...
          <div className="relative ml-14">
            ...
            {timeSlots.map((time, index) => (
              <div key={index} data-testid={`time-grid-${index}`} className={cn("border-border h-16 border-t")} />
            ))}
