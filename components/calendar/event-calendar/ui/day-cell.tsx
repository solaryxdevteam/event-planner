...
import { CalendarEvent, MonthViewConfig, TimeFormatType } from "@/lib/calendar/types";
    ...
    >
      <div className="mb-0 flex items-center justify-between sm:mb-1">
        ...
        {!monthViewConfig.hideOutsideDays && (
          <span className="text-muted-foreground hidden text-xs md:block">{format(date, "E", { locale })}</span>
        )}
      </div>
      {isWithinMonth && (
