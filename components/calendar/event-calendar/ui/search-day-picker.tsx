...
import { format, getDate, getDaysInMonth, getMonth, getYear, Locale } from "date-fns";
  ...
  const daysInMonth = useMemo(() => {
    ...
    return Array.from({ length: daysCount }, (_, i) => {
      ...
      return {
        ...
        searchableText: `${fullDayName} ${dayNum} ${format(dayDate, "d MMMM", { locale })}`.toLowerCase(),
      };
    });
              ...
              <ScrollArea className="h-[200px]">
                {filteredDays.map((day) => (
                  ...
                  >
                    ...
                    <Check className={cn("h-4 w-4", selectedDay.day === day.day ? "opacity-100" : "opacity-0")} />
                  </CommandItem>
                ))}
