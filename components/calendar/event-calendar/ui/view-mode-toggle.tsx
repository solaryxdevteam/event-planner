...
import { ViewModeType } from "@/lib/calendar/types";
...
export function ViewModeToggle({ mode, onChange, className = "", tooltipDelay = 300 }: ViewModeToggleProps) {
  return (
      ...
      >
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              <motion.div className="flex items-center" whileTap={{ scale: 0.9 }} transition={{ duration: 0.2 }}>
                <CalendarDays className={`h-4 w-4 ${mode === ViewModeType.CALENDAR ? "z-10 text-white" : ""}`} />
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              <motion.div className="flex items-center" whileTap={{ scale: 0.9 }} transition={{ duration: 0.2 }}>
                <List className={`h-4 w-4 ${mode === ViewModeType.LIST ? "z-10 text-white" : ""}`} />
                <AnimatePresence mode="wait">
