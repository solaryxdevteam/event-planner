...
export const HoverTimeIndicator = ({ hour, minute, timeFormat, hourHeight, className }: HoverTimeIndicatorProps) => {
  return (
    <div
      className={cn("pointer-events-none absolute right-0 left-30 z-20 border-t-2 border-blue-400", className)}
      style={{
