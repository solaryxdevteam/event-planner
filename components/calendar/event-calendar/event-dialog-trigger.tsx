import { EventPosition, CalendarEvent } from "@/lib/calendar/types";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import { calculateDuration, formatTimeDisplay } from "@/lib/calendar/date-utils";
...
type EventDialogTriggerProps = {
  ...
  leftOffset: number;
  rightOffset: number;
  onClick: (event: CalendarEvent, position: EventPosition, leftOffset: number, rightOffset: number) => void;
};

export const EventDialogTrigger = ({ event, position, leftOffset, rightOffset, onClick }: EventDialogTriggerProps) => {
