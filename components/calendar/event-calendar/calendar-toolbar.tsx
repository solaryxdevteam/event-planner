...
export default function CalendarToolbar() {
  const openAddEventConfirmDialog = useEventCalendarStore((state) => state.openAddEventConfirmDialog);
    ...
    <div className="flex flex-col">
      <div className="flex flex-col space-y-2 px-4 pt-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
        <div className="flex items-center space-x-3">
          <div className="flex w-full flex-col items-center justify-between gap-5 space-x-2 sm:flex-row sm:gap-0">
            <div className="flex w-full items-center justify-around sm:hidden">
              <Button variant="outline" className="hover:bg-muted rounded-full" onClick={handleNavigatePrevious}>
                <ChevronLeft className="h-4 w-4" />
                Previous
              </Button>
              <Button variant={"outline"} className="hover:bg-muted rounded-full" onClick={handleNavigateNext}>
            ...
            <div className="flex items-center space-x-2">
              ...
              {currentView !== "year" && <SearchMonthPicker locale={localeObj} monthFormat="LLLL" />}
              <SearchYearPicker yearRange={20} minYear={2000} maxYear={2035} />
            </div>
            <Button
              variant="ghost"
              size="icon"
        ...
        <div className="flex items-center justify-center space-x-3 sm:justify-start">
          ...
          <Button onClick={() => openAddEventConfirmDialog()} className="h-9 gap-1.5 px-3" variant="default">
